...
public class Fragment_Section_List extends Fragment implements ClassListListener,Section_List_Item_Click_Listener,
        SectionListListener,AddSectionListener
{

    public static String MODULE = "Fragment_Section_List ";
    ...
    public void SetActionBar()
    {
        ...
        try
        {
            if (mActivity != null)
            {
                ...
                mToolbar.setTitle(R.string.lbl_section_management);
