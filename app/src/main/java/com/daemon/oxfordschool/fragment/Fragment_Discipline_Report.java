    ...
    public void showDisciplineReport()
    {
        ...
        try
        {
            if(mDiscipline!=null)
            {
                ...
                tv_obey_rules.setText(mDiscipline.getSelfControl());
                tv_obey_staff.setText(mDiscipline.getSelfControl());
                tv_dress_code.setText(mDiscipline.getSelfControl());
                tv_time_keeping.setText(mDiscipline.getSelfControl());
                tv_conduct.setText(mDiscipline.getSelfControl());
