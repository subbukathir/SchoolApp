 ...
 */
public class Fragment_Attendance_Parent extends Fragment implements StudentsListListener,AttendanceListener,
        OnDateSelectedListener, OnMonthChangedListener
{
    public static String MODULE = "Fragment_Attendance_Parent ";
    ...
    public Fragment_Attendance_Parent()
    {
    ...
    {
        View rootView = inflater.inflate(R.layout.fragment_attendance_parent, container, false);
        TAG = "onCreateView";
        Log.d(MODULE, TAG);
        initView(rootView);
        return rootView;
   ...
   SwipeRefreshLayout.OnRefreshListener _OnRefreshListener = new SwipeRefreshLayout.OnRefreshListener()
   {
       ...
       public void onRefresh()
       {
           ...
           if(!vp_student.isShown()) vp_student.setVisibility(View.VISIBLE);
       }
   };
    ...
    public void onStudentsReceived()
    {
        ...
        try
        {
            ...
            if(mListStudents.size()>0)
            {
                showStudentsList();
                mSelectedPosition=0;
                mSelectedMonthPosition=day.getMonth()+1;
    ...
    public void getAttendanceFromService()
    {
        ...
        else
        {
            ...
            new GetAttendance(Str_Attendance_Url,Payload_Attendance(),Fragment_Attendance_Parent.this).getAttendance();
