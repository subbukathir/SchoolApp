...
public class ExamResultAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    ...
    private static String MODULE = "ExamResultAdapter";
    private static String TAG="";
    LinearLayout.LayoutParams params;

    public ExamResultAdapter(ArrayList<CResult> mListResult, Fragment mFragment)
    {
        TAG = "ExamResultAdapter";
        Log.d(MODULE, TAG);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder mHolder, final int position)
    {
        ...
        try
        {
            if(mHolder instanceof ExamResult_ListHolders)
            {
                ...
                holder.tv_exam_subject.setText(CResult.getSubjectName());
