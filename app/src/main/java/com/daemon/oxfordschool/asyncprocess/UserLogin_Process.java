 ...
 */
public class UserLogin_Process
{
    public static String MODULE = "UserLogin_Process";
    ...
    public UserLogin_Process(String Str_Url, AppCompatActivity mActivity,JSONObject object)
    {
        this.Str_Url = Str_Url;
        this.mActivity = mActivity;
        this.mObject= object;
        mCallBack = (LoginListener) mActivity;
