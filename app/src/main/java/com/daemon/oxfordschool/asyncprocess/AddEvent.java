...
{
    public static String MODULE = "AddEvent";
    public static String TAG ="";
    String Str_Msg = "",Str_Code="";
    AddEventListener mCallBack;
    String Str_Url="";
    Fragment mFragment;
    ...
    public AddEvent(String Str_Url, Fragment mFragment, JSONObject object)
    {
        this.Str_Url = Str_Url;
        this.mFragment=mFragment;
        this.object=object;
        this.mActivity = (AppCompatActivity)mFragment.getActivity();
        mCallBack = (AddEventListener) mFragment;
        ...
        public void onResponse(Object o)
        {
            try
            {
                ...
                Log.d(TAG, response.toString());
                    ...
                    {
                        editor = mPreferences.edit();
                        editor.putString(AppUtils.SHARED_ADDEVENT, response.toString());
                        editor.commit();
                        Str_Msg = response.getString("message");
                        mCallBack.onAddEventReceived(Str_Msg);
                    }
                    else
                    {
                        Str_Msg = response.getString("message");
                        mCallBack.onAddEventReceivedError(Str_Msg);
                    }
