...
{
    public static String MODULE = "AddMarks";
    public static String TAG ="";
    String Str_Msg = "",Str_Code="";
    AddMarksListener mCallBack;
    String Str_Url="";
    Fragment mFragment;
    ...
    public AddMarks(String Str_Url, Fragment mFragment, JSONObject object)
    {
        this.Str_Url = Str_Url;
        this.mFragment=mFragment;
        this.object=object;
        this.mActivity = (AppCompatActivity)mFragment.getActivity();
        mCallBack = (AddMarksListener) mFragment;
        ...
        public void onResponse(Object o)
        {
            try
            {
                ...
                Log.d(TAG, response.toString());
                    ...
                    {
                        editor = mPreferences.edit();
                        editor.putString(AppUtils.SHARED_ADDMARKS, response.toString());
                        editor.commit();
                        Str_Msg = response.getString("message");
                        mCallBack.onAddMarksReceived(Str_Msg);
                    }
                    else
                    {
                        Str_Msg = response.getString("message");
                        mCallBack.onAddMarksReceivedError(Str_Msg);
                    }
