...
{
    public static String MODULE = "AddSubject";
    public static String TAG ="";
    String Str_Msg = "",Str_Code="";
    AddSubjectListener mCallBack;
    String Str_Url="";
    Fragment mFragment;
    ...
    public AddSubject(String Str_Url, Fragment mFragment, JSONObject object)
    {
        this.Str_Url = Str_Url;
        this.mFragment=mFragment;
        this.object=object;
        this.mActivity = (AppCompatActivity)mFragment.getActivity();
        mCallBack = (AddSubjectListener) mFragment;
        ...
        public void onResponse(Object o)
        {
            try
            {
                ...
                Log.d(TAG, response.toString());
                    ...
                    {
                        editor = mPreferences.edit();
                        editor.putString(AppUtils.SHARED_ADDSUBJECT, response.toString());
                        editor.commit();
                        Str_Msg = response.getString("message");
                        mCallBack.onAddSubjectReceived(Str_Msg);
                    }
                    else
                    {
                        Str_Msg = response.getString("message");
                        mCallBack.onAddSubjectReceivedError(Str_Msg);
                    }
