...
{
    public static String MODULE = "AddExam";
    public static String TAG ="";
    String Str_Msg = "",Str_Code="";
    AddExamListener mCallBack;
    String Str_Url="";
    Fragment mFragment;
    AppCompatActivity mActivity;
    JSONObject object;

    public AddExam(String Str_Url, Fragment mFragment, JSONObject object)
    {
        this.Str_Url = Str_Url;
        this.mFragment=mFragment;
        this.object=object;
        this.mActivity = (AppCompatActivity)mFragment.getActivity();
        mCallBack = (AddExamListener) mFragment;
    }
            ...
            try
            {
                ...
                Log.d(TAG, response.toString());
                    ...
                    if (Str_Code.equals(ApiConstants.SUCCESS_CODE))
                    {
                        ...
                        mCallBack.onAddExamReceived(Str_Msg);
                    }
                    else
                    {
                        Str_Msg = response.getString("message");
                        mCallBack.onAddExamReceivedError(Str_Msg);
                    }
