 ...
 */
public class AddDiaryNotes
{
    public static String MODULE = "AddDiaryNotes";
    public static String TAG ="";
    String Str_Msg = "",Str_Code="";
    AddDiaryNotesListener mCallBack;
    String Str_Url="";
    Fragment mFragment;
    ...
    public AddDiaryNotes(String Str_Url, Fragment mFragment, JSONObject object)
    {
        this.Str_Url = Str_Url;
        this.mFragment=mFragment;
        this.object=object;
        this.mActivity = (AppCompatActivity)mFragment.getActivity();
        mCallBack = (AddDiaryNotesListener) mFragment;
            ...
            try
            {
                ...
                Log.d(TAG, response.toString());
                    ...
                    if (Str_Code.equals(ApiConstants.SUCCESS_CODE))
                    {
                        ...
                        mCallBack.onDiaryNotesReceived(Str_Msg);
                    }
                    else
                    {
                        Str_Msg = response.getString("message");
                        mCallBack.onDiaryNotesReceivedError(Str_Msg);
                    }
