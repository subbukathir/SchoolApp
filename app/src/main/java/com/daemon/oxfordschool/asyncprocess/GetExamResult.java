...
{
    public static String MODULE = "GetExamResult";
    public static String TAG ="";
    String Str_Msg = "",Str_Code="";
    ExamResultListener mCallBack;
    String Str_Url="";
    JSONObject Payload;
    Fragment mFragment;
    ...
    public GetExamResult(String Str_Url, JSONObject Payload, Fragment mFragment)
    {
        this.Str_Url = Str_Url;
        this.Payload = Payload;
        this.mFragment=mFragment;
        this.mActivity = (AppCompatActivity)mFragment.getActivity();
        mCallBack = (ExamResultListener) mFragment;
        ...
        public void onResponse(Object o)
        {
            try
            {
                ...
                if (response.toString().length()==0)
                {
                    ...
                    mCallBack.onExamResultReceivedError(Str_Msg);
                }
                else
                {
                    ...
                    if (Str_Code.equals(ApiConstants.SUCCESS_CODE))
                    {
                        ...
                        editor.commit();
                        mCallBack.onExamResultReceived();
                    }
                    else
                    {
