...
public class UpdateClass
{
    ...
    AddClassListener mCallBack;
    String Str_Url="";
    Fragment mFragment;
    AppCompatActivity mActivity;
    JSONObject object;

    public UpdateClass(String Str_Url, Fragment mFragment, JSONObject object)
    {
        this.Str_Url = Str_Url;
        this.mFragment=mFragment;
        this.object=object;
        this.mActivity = (AppCompatActivity)mFragment.getActivity();
        mCallBack = (AddClassListener) mFragment;
    }
            ...
            try
            {
                ...
                Log.d(TAG, response.toString());
                    ...
                    if (Str_Code.equals(ApiConstants.SUCCESS_CODE))
                    {
                        ...
                        mCallBack.onClassUpdated(Str_Msg);
                    }
                    else
                    {
                        Str_Msg = response.getString("message");
                        mCallBack.onClassUpdatedError(Str_Msg);
                    }
