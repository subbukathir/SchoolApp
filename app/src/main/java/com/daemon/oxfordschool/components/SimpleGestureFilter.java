...
/**
 * Created by daemonsoft on 22/4/16.
 */
public class SimpleGestureFilter extends GestureDetector.SimpleOnGestureListener
{
    ...
    public SimpleGestureFilter(AppCompatActivity mActivity,SimpleGestureListener sgl) {

        this.mActivity = mActivity;
        this.detector = new GestureDetector(mActivity, this);
        this.listener = sgl;
    }
    ...
    public boolean onSingleTapConfirmed(MotionEvent arg) {
        ...
        if(this.mode == MODE_DYNAMIC){        // we owe an ACTION_UP, so we fake an
            ...
            this.mActivity.dispatchTouchEvent(arg);
        }
